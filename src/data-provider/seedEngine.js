...
export const seedEngine = {
  // Demo seeding removed — no hardcoded demo data is injected.
  async seedDemo() { return {}; },

  // Permission catalog seeding removed — permissions are managed through the UI.
  async seedPermissions() { return 0; },
