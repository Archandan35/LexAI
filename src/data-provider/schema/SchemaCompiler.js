...
function systemSqlSeedData() {
  ...
  return [
    ...
    `insert into provider_adapter_registry (id, provider, adapter_name, adapter_version, active)`,
    `values ('default', 'supabase', 'SupabaseAdapter', '1.0.0', true)`,
    'on conflict (id) do update set active = true, adapter_name = excluded.adapter_name;',
